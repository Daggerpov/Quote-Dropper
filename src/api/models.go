...
type quote struct {
	...
	CreatedAt      *time.Time `json:"created_at"`     // Timestamp when quote was submitted (nullable)
	UpdatedAt      *time.Time `json:"updated_at"`     // Timestamp when quote was last updated (nullable)
